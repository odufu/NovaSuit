                            ...
                            children: [
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text('Base Product', style: TextStyle(fontSize: 12, color: textMuted)),
                                    const SizedBox(height: 2),
                                    Text(order.productId, style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: textPrimary)),
                                  ],
                                ),
                              ),
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text('Base Package Price', style: TextStyle(fontSize: 12, color: textMuted)),
                                    const SizedBox(height: 2),
                                    Text('₦${order.totalAmount.toStringAsFixed(0)}', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: textPrimary)),
                                  ],
                                ),
                              ),
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text('Requested Total', style: TextStyle(fontSize: 12, color: textMuted)),
                                    const SizedBox(height: 2),
                                    Text(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              ElevatedButton.icon(
                                ...
                                label: const Text('Approve Upsell (+₦10,000)'),
                              ),
                            ],
                          ),
                        ],
