                    ...
                    Row(
                      children: [
                        ...
                        ElevatedButton.icon(
                          ...
                          label: Text('Reassign (${selectedIdsVal.length}) Leads'),
                        ),
                      ],
                    ),
                  ],
                      ...
                      children: [
                        Padding(
                          ...
                          child: Row(
                            children: [
                              Checkbox(
                                value: selectedIdsVal.length == uncalledOrders.length && uncalledOrders.isNotEmpty,
                                onChanged: (val) {
                                  if (val == true) {
                                    _selectedOrderIds.value = uncalledOrders.map((o) => o.id).toSet();
                                  } else {
                                    _selectedOrderIds.value = {};
                                  }
                                },
