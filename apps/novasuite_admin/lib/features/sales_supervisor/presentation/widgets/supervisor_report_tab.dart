                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          ...
                          style: GoogleFonts.jetBrainsMono(fontSize: 12, fontWeight: FontWeight.bold, color: const Color(0xFF10B981)),
                        ),
                      ),
                    ],
                  ),
                ...
                Wrap(
                  ...
                  children: r.productBreakdown.map((p) {
                    return Container(
                      ...
                      child: Text(
                        p,
                        style: GoogleFonts.inter(fontSize: 11, fontWeight: FontWeight.bold, color: Colors.amber),
                      ),
                    );
                  }).toList(),
                ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                      ...
                      label: Text('Copy Text', style: GoogleFonts.inter(fontWeight: FontWeight.bold)),
                    ),
                  ],
                ),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(title, style: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.bold, color: isDark ? const Color(0xFFCBD5E1) : const Color(0xFF334155))),
                const SizedBox(height: 2),
                Text(value, style: GoogleFonts.outfit(fontSize: 18, fontWeight: FontWeight.bold, color: color)),
                const SizedBox(height: 2),
                Text(subtitle, style: GoogleFonts.inter(fontSize: 10, color: isDark ? const Color(0xFF94A3B8) : const Color(0xFF475569)), overflow: TextOverflow.ellipsis),
              ],
            ),
          ),
        ],
