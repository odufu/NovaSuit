          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    const Icon(Icons.add_comment_rounded, color: Color(0xFF10B981), size: 20),
                    ...
                    IconButton(
                      ...
                      icon: Icon(Icons.close, color: isDarkMode ? Colors.white60 : Colors.grey.shade600, size: 18),
                ...
                // Channel Selection Pills (Responsive Equal Row)
                ...
                Row(
                  children: [
                    _buildChannelChoicePill(CommChannelType.voiceCall, '📞 Voice', isDarkMode),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintStyle: TextStyle(color: isDarkMode ? Colors.white38 : Colors.grey.shade500, fontSize: 11),
                    filled: true,
                ...
                // Open-Ended vs Order Attachment Options
                Text(
                  'CONVERSATION TYPE',
                  ...
                  children: [
                    Expanded(
                      child: FilterChip(
                        ...
                        label: const Center(child: Text('Open-Ended Inquiry', style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold))),
                        ...
                        side: BorderSide(color: _isOpenEnded ? const Color(0xFF10B981) : (isDarkMode ? const Color(0xFF1E3E33) : Colors.grey.shade300)),
                      ),
                    ),
                    const SizedBox(width: 6),
                    Expanded(
                      child: FilterChip(
                        selected: !_isOpenEnded,
                        label: const Center(child: Text('Attach to Order', style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold))),
                ...
                if (!_isOpenEnded) ...[
                  DropdownButtonFormField<OrderModel>(
                    ...
                    style: TextStyle(fontSize: 11, color: isDarkMode ? Colors.white : Colors.black87),
                    isExpanded: true,
                    decoration: InputDecoration(
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    icon: Icon(_selectedChannel == CommChannelType.voiceCall ? Icons.phone_in_talk : Icons.send_rounded, size: 16),
                    label: Text(
